      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
        ...
        <div className='bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700 flex flex-col'>
          <div className='mb-3'>
            ...
            {/* <p className='text-xs text-gray-500 dark:text-gray-400'>({t('fire.reality.snapshot.p1.source')})</p> */}
          </div>
        ...
        <div className='bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700 flex flex-col'>
          <div className='mb-3'>
            ...
            {/* <p className='text-xs text-gray-500 dark:text-gray-400'>({t('fire.reality.snapshot.p3.source')})</p> */}
          </div>
        ...
        <div className='bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700 flex flex-col'>
          <div className='mb-3'>
            ...
            {/* <p className='text-xs text-gray-500 dark:text-gray-400'>({t('fire.reality.snapshot.p4.source')})</p> */}
          </div>
