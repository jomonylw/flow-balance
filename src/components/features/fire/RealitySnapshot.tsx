      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
        ...
        <div className='bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700'>
          <div className='mb-3'>
            ...
            <p className='text-xs text-gray-500 dark:text-gray-400'>(P1来源)</p>
          </div>
        ...
        <div className='bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700'>
          <div className='mb-3'>
            ...
            <p className='text-xs text-gray-500 dark:text-gray-400'>(P3来源)</p>
          </div>
        ...
        <div className='bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700'>
          <div className='mb-3'>
            ...
            <p className='text-xs text-gray-500 dark:text-gray-400'>(P4来源)</p>
          </div>
