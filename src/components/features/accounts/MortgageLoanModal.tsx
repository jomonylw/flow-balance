...
interface MortgageLoanModalProps {
  isOpen: boolean
  onClose: () => void
      ...
      <div className='bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto relative'>
        <div className='sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4'>
          <div className='flex items-center justify-between'>
            <h2 className='text-xl font-semibold text-gray-900 dark:text-gray-100'>
              {editingContract
                ? t('mortgage.loan.edit')
                : t('mortgage.loan.create')}
            </h2>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className='p-6 space-y-6'>
          ...
          <div className='space-y-6'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <div className='md:col-span-2'>
                ...
                <input
                  ...
                  placeholder={t('mortgage.loan.contract.name.placeholder')}
                  required
                />
              </div>
              ...
              <div>
                <label className='block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2'>
                  {t('mortgage.loan.amount')} ({accountCurrency}) *
                </label>
                <input
                  type='number'
                  step='0.01'
              ...
              <div>
                ...
                >
                  <option value='120'>
                    {t('mortgage.loan.periods.10years')}
                  </option>
                  <option value='180'>
                    {t('mortgage.loan.periods.15years')}
                  </option>
                  <option value='240'>
                    {t('mortgage.loan.periods.20years')}
                  </option>
                  <option value='300'>
                    {t('mortgage.loan.periods.25years')}
                  </option>
                  <option value='360'>
                    {t('mortgage.loan.periods.30years')}
                  </option>
                </select>
              </div>
              ...
              <div>
                <label className='block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2'>
                  {t('mortgage.loan.repayment.type')} *
                </label>
                <select
                ...
                >
                  <option value='EQUAL_PAYMENT'>
                    {t('mortgage.loan.repayment.equal.payment')}
                  </option>
                  <option value='EQUAL_PRINCIPAL'>
                    {t('mortgage.loan.repayment.equal.principal')}
                  </option>
                </select>
              </div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                ...
                <div>
                  ...
                  <p className='mt-1 text-xs text-gray-500 dark:text-gray-400'>
                    {t('mortgage.loan.payment.day.description')}
                  </p>
                </div>

                <div className='md:col-span-2'>
                  <label className='block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2'>
                    {t('mortgage.loan.payment.account')}
                  </label>
                  <select
                  ...
                  >
                    <option value=''>
                      {t('mortgage.loan.payment.account.select')}
                    </option>
                    {expenseAccounts.length > 0 ? (
                      ...
                      <option disabled>
                        {t('mortgage.loan.payment.account.no.available')}
                      </option>
                    )}
                  </select>
                  <p className='mt-1 text-xs text-gray-500 dark:text-gray-400'>
                    {t('mortgage.loan.payment.account.description')}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='border-t border-gray-200 dark:border-gray-700 pt-6'>
              <h3 className='text-lg font-medium text-gray-900 dark:text-gray-100 mb-4'>
                {t('mortgage.loan.transaction.template')}
              </h3>
                ...
                <div>
                  ...
                  <input
                    ...
                    className='w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md
                             ...
                             focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                    placeholder={t(
                      'mortgage.loan.transaction.description.placeholder'
                    )}
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className='w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md
                             ...
                             focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                    placeholder={t(
                      'mortgage.loan.transaction.notes.placeholder'
                    )}
                  />
                </div>
          ...
          <div className='flex justify-end space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700'>
            ...
            >
              {isLoading ? t('common.processing') : t('mortgage.loan.save')}
            </button>
          </div>
        </form>
      </div>
