...
export default function AccountSummaryCard({
  ...
  const calculateStockStats = () => {
    ...
    return {
      ...
      yearToDateChange:
        yearStartBalance !== 0
          ? ((balance - yearStartBalance) / Math.abs(yearStartBalance)) * 100
          : 0,
    }
  }
        ...
        <div className='mt-6 pt-6 border-t border-gray-200'>
          <div className='grid grid-cols-2 md:grid-cols-4 gap-4 text-sm'>
            ...
            <div>
              ...
              <div className='font-medium text-blue-600'>时点余额</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='bg-white shadow rounded-lg p-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-6'>
          ...
          <div className='text-center md:text-left'>
            ...
            >
              {currencySymbol}
              {flowStats.totalAmount.toLocaleString('zh-CN', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2,
              })}
            </div>
        ...
        <div className='mt-6 pt-6 border-t border-gray-200'>
          <div className='grid grid-cols-2 md:grid-cols-4 gap-4 text-sm'>
            ...
            <div>
              ...
              >
                {currencySymbol}
                {flowStats.thisYearAmount.toLocaleString('zh-CN', {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
                })}
              </div>
            ...
            <div>
              <span className='text-gray-500'>数据类型</span>
              <div className='font-medium text-purple-600'>期间流量</div>
            </div>
          </div>
        </div>
      </div>
