    ...
    const option: echarts.EChartsOption = {
      ...
      tooltip: {
        ...
        formatter: function (params: unknown) {
          ...
          let result = `<div style="font-weight: bold; margin-bottom: 5px;">${firstParam?.axisValue || ''}</div>`
    ...
    const option: echarts.EChartsOption = {
      ...
      tooltip: {
        ...
        formatter: function (params: unknown) {
          const paramsArray = Array.isArray(params) ? params : [params]
          const firstParam = paramsArray[0] as TooltipParam
          let result = `<div style="font-weight: bold; margin-bottom: 8px;">${firstParam?.axisValue || ''}</div>`
          let total = 0
