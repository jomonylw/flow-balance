...
import type { NetWorthCardProps } from '@/types/components'
        ...
        <div className='ml-5 w-0 flex-1'>
          <dl>
            ...
            <dd className='flex items-baseline'>
              <div
                className={`text-2xl font-semibold ${netWorth >= 0 ? 'text-gray-900' : 'text-red-600'}`}
              >
                {currencySymbol}
                {netWorth.toLocaleString('zh-CN', {
        ...
        <div className='grid grid-cols-2 gap-4 text-sm'>
          ...
          <div>
            ...
            <div className='font-medium text-red-600'>
              {currencySymbol}
              {liabilities.toLocaleString('zh-CN', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2,
              })}
            </div>
