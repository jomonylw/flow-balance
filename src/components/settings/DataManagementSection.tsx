  ...
  const handleExportData = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage(t('data.export.failed', { error: data.error || t('error.unknown') }))
      }
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      {message && (
        <div className={`px-4 py-3 rounded-lg border ${
          message.includes(t('common.success')) || message.includes(t('data.export.success'))
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 sm:p-6">
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1 min-w-0">
            <h4 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">{t('data.export.title')}</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              {t('data.export.description')}
            </p>
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-3 mb-4">
              <h5 className="text-sm font-medium text-blue-900 dark:text-blue-200 mb-2">{t('data.export.includes')}：</h5>
      ...
      <div className="bg-white dark:bg-gray-800 border border-red-200 dark:border-red-700 rounded-lg p-4 sm:p-6">
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1 min-w-0">
            <h4 className="text-lg font-medium text-red-900 dark:text-red-200 mb-2">{t('data.delete.title')}</h4>
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-lg p-3 mb-4">
              <p className="text-sm text-red-800 dark:text-red-200 font-medium mb-2">
                ⚠️ {t('data.delete.warning')}
              </p>
              <p className="text-sm text-red-700 dark:text-red-300 mb-3">{t('data.delete.includes')}：</p>
