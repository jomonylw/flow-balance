  ...
  if (exchangeRates.length === 0) {
    return (
      <div className="text-center py-8 text-gray-500 dark:text-gray-400">
        ...
        <p className="text-lg font-medium mb-2">{t('exchange.rate.empty.title')}</p>
      ...
      <div className="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
        <div className="px-4 py-5 sm:p-6">
          <div className="flex justify-between items-center mb-4">
            <h4 className="text-lg font-medium text-gray-900 dark:text-gray-100">{t('exchange.rate.list')}</h4>
            <button
              onClick={onRefresh}
                  ...
                  <tr key={rate.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex justify-end space-x-2">
                        ...
                        >
                          {deletingId === rate.id ? t('common.deleting') : t('common.delete')}
                        </button>
                      </div>
                    </td>
                  </tr>
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 dark:bg-gray-900 dark:bg-opacity-75 overflow-y-auto h-full w-full z-50">
          <div className="relative top-20 mx-auto p-5 border border-gray-200 dark:border-gray-600 w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
            <div className="mt-3 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mt-4">{t('exchange.rate.delete.confirm.title')}</h3>
              ...
              <div className="flex justify-center space-x-4 mt-4">
                ...
                >
                  {deletingId === showDeleteConfirm ? t('common.deleting') : t('exchange.rate.delete.confirm')}
                </button>
              </div>
            </div>
          </div>
