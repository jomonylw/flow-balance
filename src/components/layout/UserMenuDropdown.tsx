        ...
        <div className="px-2 space-y-1">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{t('menu.settings.description')}</div>
            </div>
          </Link>
        </div>
            ...
            <>
              ...
              <div className="group flex items-center px-3 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{t('settings.theme.description')}</div>
                </div>
              </div>
              ...
              <div className="group flex items-center px-3 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{t('settings.language.description')}</div>
                </div>
              </div>
            </>
          )}
        ...
        <div className="px-2 space-y-1">
          ...
          >
            ...
            <div className="flex-1 text-left">
              ...
              <div className="text-xs text-red-500 dark:text-red-400 mt-0.5">{t('menu.logout.description')}</div>
            </div>
          </button>
        </div>
      </div>
