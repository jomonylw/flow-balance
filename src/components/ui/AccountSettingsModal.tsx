    ...
    <Modal isOpen={isOpen} onClose={onClose} title={t('account.settings')} size="lg">
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">{t('account.settings.basic.info')}</h3>
        ...
        {/* 颜色设置 */}
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">{t('account.settings.display.settings')}</h3>
        ...
        {/* 货币设置 */}
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">{t('account.settings.currency.settings')}</h3>
